...
public class VodSdkTest {
    ...
    String accessKeyId = "{aliyun}";
    String accessKeySecret = "{aliyun}";
    ...
    public void testGetVideoPlayAuth() throws ClientException {
        ...
        try {
            ...
            //设置请求参数
            request.setVideoId("37f369b26bb24247ab77ea4209eab9ae");
            //获取请求响应
    ...
    public void testUploadVideo(){
        ...
        //文件名必须包含扩展名
        String fileName = "C:\\Users\\Ytz\\Desktop\\6 - What If I Want to Move Faster.mp4";
        //本地文件上传
